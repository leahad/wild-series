...
class EpisodeController extends AbstractController
{
    ...
    public function show(Episode $episode, $slug): Response
    {
    ...
    public function edit(Request $request, Episode $episode, EpisodeRepository $episodeRepository, SluggerInterface $slugger,$slug): Response
    {
        $form = $this->createForm(EpisodeType::class, $episode);
        $form->handleRequest($request);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'The episod has been edited');
    ...
    public function delete(Request $request, Episode $episode, EpisodeRepository $episodeRepository, $slug): Response
    {
